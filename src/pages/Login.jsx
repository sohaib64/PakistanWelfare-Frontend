                ...
                <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="text-white space-y-6 animate-slide-in hidden lg:block">
                        ...
                        <p className="text-gray-300 text-lg">
                            ...
                            dashboard to track donations, volunteer activities, and more.
                        </p>

                        <div className="space-y-3 pt-4 text-gray-200">
                            <div className="flex items-center gap-3">💚 Track Your Contributions</div>
                            <div className="flex items-center gap-3">📊 View Impact Dashboard</div>
                            <div className="flex items-center gap-3">🤝 Connect with Community</div>
                        </div>
                    </div>
